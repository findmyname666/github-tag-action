...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let newVersion;
        if (customTag) {
            commits = yield (0, utils_1.getCommits)(latestTag.commit.sha, commitRef, pathFilter);
            ...
            commits = yield (0, utils_1.getCommits)(previousTag.commit.sha, commitRef, pathFilter);
            ...
            if (mappedReleaseRules) {
                // analyzeCommits doesn't appreciate rules with a section /shrug
                releaseRules = mappedReleaseRules.map((_a) => {
