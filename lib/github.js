...
exports.createTag = exports.compareCommitsWithFiles = exports.compareCommits = exports.listTags = exports.getOctokitSingleton = void 0;
 ...
 * @param headRef - new commit
 */
function compareCommitsWithFiles(baseRef, headRef) {
    return __awaiter(this, void 0, void 0, function* () {
        const octokit = getOctokitSingleton();
        core.debug(`Comparing commits with files (${baseRef}...${headRef})`);
        // Get the comparison data
        const comparison = yield octokit.repos.compareCommits(Object.assign(Object.assign({}, github_1.context.repo), { base: baseRef, head: headRef }));
        // Fetch detailed file information for each commit
        const commitsWithFiles = yield Promise.all(comparison.data.commits.map((commit) => __awaiter(this, void 0, void 0, function* () {
            const commitDetails = yield octokit.repos.getCommit(Object.assign(Object.assign({}, github_1.context.repo), { ref: commit.sha }));
            return Object.assign(Object.assign({}, commit), { files: commitDetails.data.files || [] });
        })));
        return commitsWithFiles;
    });
}
exports.compareCommitsWithFiles = compareCommitsWithFiles;
