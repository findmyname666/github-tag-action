...
function getCommits(baseRef, headRef, targetPath) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const filteredCommits = commits
            ...
            if (!matchesPath) {
                core.info(`Filtered out commit ${commit.sha} - no matching files for path: ${targetPath}`);
                core.info(`Files in commit: ${(_b = commit.files) === null || _b === void 0 ? void 0 : _b.map((f) => f.filename).join(', ')}`);
            }
            return matchesPath;
        })
            .map((commit) => ({
