...
function getCommits(baseRef, headRef, targetPath) {
    return __awaiter(this, void 0, void 0, function* () {
        const commits = yield (0, github_1.compareCommitsWithFiles)(baseRef, headRef);
        ...
        const filteredCommits = commits
            ...
            if (!targetPath)
                return true;
            const matchesPath = (_a = commit.files) === null || _a === void 0 ? void 0 : _a.some((file) => { var _a; return (_a = file.filename) === null || _a === void 0 ? void 0 : _a.startsWith(targetPath); });
            if (!matchesPath) {
                core.debug(`Filtered out commit ${commit.sha} - no matching files for path: ${targetPath}`);
                core.debug(`Files in commit: ${(_b = commit.files) === null || _b === void 0 ? void 0 : _b.map((f) => f.filename).join(', ')}`);
            }
            return matchesPath;
        })
            .map((commit) => ({
